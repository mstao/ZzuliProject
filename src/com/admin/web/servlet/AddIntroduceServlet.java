 ...
 */
/** 
 * @ClassName: AddIntroduceServlet 
 * @Description: TODO 添加实验室简介相关信息 
 * @date 2016年12月28日 上午10:32:03  
 */
@WebServlet("/AddIntroduceServlet")
public class AddIntroduceServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(ui==1){
	    	pid=new AddContentDaoImpl().AddIntroduceInfo(type, content, author, is_publish);
	    }else if(ui==0){
	        boolean b_id=new UpadateContentDaoImpl().upadteIntroInfo(iid, content, author, is_publish);
	        if(b_id==true){
	        	pid=1;
	        }else{
	        	pid=0;
