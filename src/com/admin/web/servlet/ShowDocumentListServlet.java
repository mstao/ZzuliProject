...
/**
 * Servlet implementation class ShowDocumentListServlet
 */
/** 
 * @ClassName: ShowDocumentListServlet 
 * @Description: TODO 获取文档列表信息
 * @date 2016年12月30日 下午7:04:39  
 */
@WebServlet("/ShowDocumentListServlet")
public class ShowDocumentListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowDocumentListServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("./admin/document/documentList.jsp").forward(request, response);
	}
