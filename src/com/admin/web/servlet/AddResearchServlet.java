...
/**
 * Servlet implementation class AddResearchServlet
 */
/** 
 * @ClassName: AddResearchServlet 
 * @Description: TODO 添加科学研究信息
 * @date 2016年12月27日 下午7:43:24  
 */
@WebServlet("/AddResearchServlet")
public class AddResearchServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   // System.out.println(content+"----"+title+"-----"+author);
	    ...
	    int id=new AddContentDaoImpl().AddResearchInfo(type, title, content, author, is_publish, is_image);
	    String rs;
	    if(id>0){
