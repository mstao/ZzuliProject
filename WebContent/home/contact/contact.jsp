...
<title>${WEB_FOOTER_CONTACT}</title>
...
<body>
	...
	<div class="main">
		...
		<!--S 左边导航栏-->
		<div class="left-nav">
			<span class="common-tag">&nbsp;${WEB_FOOTER_CONTACT}</span>
	        <div class="example-img"><img src="${pageContext.request.contextPath}/home/img/notice.png"/></div>
			<ul>
				<li><a href="${pageContext.request.contextPath}/contact.do" >${WEB_FOOTER_CONTACT}</a></li>	
			</ul>
		</div>
		<!--S 左边导航栏-->
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="javascript:void(0);">首页</a> - <a href="${pageContext.request.contextPath}/contact.do">${WEB_FOOTER_CONTACT}</a></div>
		   	<!--S 具体内容-->
