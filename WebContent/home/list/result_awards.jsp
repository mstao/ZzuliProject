...
<title>${WEB_RESULT_REWRADS}</title>
...
<%--奖励 --%>
	...
	<div class="main">
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/reward.do">${WEB_RESULT_NAVI}</a> - <a href="javascript:void(0);">${WEB_RESULT_REWRADS}</a></div>
		   <!--S 具体内容-->
		...
		<c:if test="${not empty awards}">
			...
			<c:forEach items="${awards}" var="awards" varStatus="xh">
			<tr>
