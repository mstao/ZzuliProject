	...
	<div class="main">
		...
		<div class="left-nav">
			...
			<ul>
				...
				<li><a href="${pageContext.request.contextPath}/introduce.do?type=igw" >${WEB_INTRO_GUANLI}</a></li>
				<li><a href="${pageContext.request.contextPath}/introduce.do?type=ixw" >${WEB_INTRO_XUESHU}</a></li>	
				<li><a href="${pageContext.request.contextPath}/introduce.do?type=isz">${WEB_INTRO_SHIYAN}</a></li>
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/introduce.do?type=isg">${WEB_INTRO_NAVI}</a> - <a href="javascript:void(0);">${WEB_INTRO_RULES}</a></div>
		   <!--S 具体内容-->
		   <div class="details-content">
		   	<ul>
		   	   <c:forEach items="${rules}" var="rules_details">
		   		 <li><img src="${pageContext.request.contextPath}/home/img/j_do.png" class="dot"/> <a href="${pageContext.request.contextPath}/ruledetails.do?rid=${rules_details.id}">${rules_details.rule_title}</a><img src="${pageContext.request.contextPath}/home/img/hot.gif"/><span class="pub-data sub-time">[${rules_details.add_time}]</span></li>
		   	   </c:forEach> 
		   	</ul>
		   </div>
		   <!--E 具体内容-->
