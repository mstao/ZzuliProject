...
<body>
	...
	<div class="main">
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/research.do?type=kpj&p=1">${WEB_RESEARCH_NAVI}</a> - <a href="javascript:void(0);">${type_name}</a></div>
		   <!--S 具体内容-->
		   <div class="details-content">
		   	<ul>
		   	   <c:forEach items="${research}" var="research_details">
		   		 <li><img src="${pageContext.request.contextPath}/home/img/j_do.png" class="dot"/> <a href="${pageContext.request.contextPath}/researchdetails.do?id=${research_details.id}&type=${research_details.type_flag}">${research_details.item_title}</a><img src="${pageContext.request.contextPath}/home/img/hot.gif"/><span class="pub-data sub-time">[${research_details.add_time}]</span></li>
		   	   </c:forEach> 
		   	</ul>
		   </div>
		   <!--E 具体内容-->
