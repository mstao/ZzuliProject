...
<title>${WEB_RESEARCH_PROJECT_HORIZONTAL_COOPERATION}</title>
...
<%--横向合作 --%>
	...
	<div class="main">
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/research.do?type=kyl&p=1">${WEB_RESEARCH_NAVI}</a> - <a href="javascript:void(0);">${WEB_RESEARCH_PROJECT_HORIZONTAL_COOPERATION}</a></div>
		   <!--S 具体内容-->
		   <div class="details-content">
		   	<div class="project-list">
		<table >
		<c:if test="${not empty cooperation}">
			<tr>
				<th width="8%">序号</th>
				<th width="40%">项目名称</th>
				<th width="17%">合作单位</th>
			...
			<c:forEach items="${cooperation}" var="cooperation" varStatus="xh">
			<tr>
