...
<body>
	...
	<div class="main">
		...
		<div class="left-nav">
			...
			<ul>
			<%-- <li><a href="${pageContext.request.contextPath}/personintro.do" >${WEB_PERSON_STATUS}</a></li> --%>
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/person.do?type=rrx&p=1">${WEB_PERSON_NAVI}</a> - <a href="javascript:void(0);">${WEB_PERSON_GUGAN}</a></div>
			<!--S 具体内容-->
		    <div class="details-content-text">
		    	<table class="details-content-table1">
		    		<tr>
		    		<c:forEach items="${person}" var="person">
		    			<td><a href="${pageContext.request.contextPath}/persondetails.do?id=${person.id}"><img src="${person.avatar_file}"/></a><span><a href="#">${person.person_post}${person.person_name}</a></span></td>
