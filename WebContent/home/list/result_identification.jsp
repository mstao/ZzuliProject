...
<title>${WEB_RESULT_JIANDING}</title>
 ...
 --%>
	...
	<div class="main">
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/reward.do">${WEB_RESULT_NAVI}</a> - <a href="javascript:void(0);">${WEB_RESULT_JIANDING}</a></div>
		   <!--S 具体内容-->
		   <div class="details-content">
		   	<div class="project-list">
		<table >
		<c:if test="${not empty identification}">
			<tr>
				<th width="8%">序号</th>
				<th width="40%">成果名称</th>
				<th width="10%">完成人</th>
			...
			<c:forEach items="${identification}" var="identification" varStatus="xh"> 
			<tr>
