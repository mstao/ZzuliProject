...
<title>${WEB_RESEARCH_PROJECT_PROVINCIAL}</title>
...
<%--省部级重大（点）项目 --%>
	...
	<div class="main">
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/research.do?type=kyl&p=1">${WEB_RESEARCH_NAVI}</a> - <a href="javascript:void(0);">${WEB_RESEARCH_PROJECT_PROVINCIAL}</a></div>
		   <!--S 具体内容-->
		   <div class="details-content">
		   	<div class="project-list">
		<table >
		<c:if test="${not empty provincial}">
			<tr>
				<th width="8%">序号</th>
		  ...
		  <c:forEach items="${provincial}" var="provincial" varStatus="xh">
			<tr>
				
				<td>${xh.count}</td>
				<td>${provincial.nameid}</td>
