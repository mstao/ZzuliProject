...
<body>
	...
	<div class="news-details-main">
		...
		<div class="news-details-navi"><a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/news.do?type=${type}&p=1">${item_details.type_name}</a> - 内容</div>
		<div class="newstop">
		...
		<span class="last-updated-news-span"><img src="${pageContext.request.contextPath}/home/img/lasttrends.png"/> 最近更新</span>
	     <div class="small-div-content  current_new">
	    	...
	    	<c:forEach items="${item_current}" var="item_current_info">    
	    		<li><a href="${pageContext.request.contextPath}/newsdetails.do?id=${item_current_info.id}&type=${item_current_info.type_flag}" class="block_a">${item_current_info.item_title}</a><span class="sub-time">[${item_current_info.add_time}]</span> </li>
	        </c:forEach>
	    	</ul>
	    </div>
	</div>
