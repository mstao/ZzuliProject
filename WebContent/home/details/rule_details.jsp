...
<title><c:forEach items="${rule_details}" var="rule_details">${rule_details.rule_title}</c:forEach></title>
...
<body>
	...
	<div class="news-details-main">
		...
		<div class="news-details-navi"><a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/news.do?type=xgt&p=1">规章制度</a> - 内容</div>
		<div class="newstop">
		
			<div class="newsinfo">
			<center><h1>${rule_details.rule_title} </h1></center>
		...
		<span class="last-updated-news-span"><img src="${pageContext.request.contextPath}/home/img/lasttrends.png"/> 最近更新</span>
	     <div class="small-div-content  current_new">
	    	...
	    	<c:forEach items="${rules_current}" var="rules_current">    
	    		<li><a href="${pageContext.request.contextPath}/ruledetails.do?rid=${rules_current.id}" class="block_a">${rules_current.rule_title}</a><span class="sub-time">[${rules_current.add_time}]</span> </li>
	        </c:forEach>
	    	</ul>
	    </div>
	</div>
