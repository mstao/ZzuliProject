...
<div class="main">
	...
	<div class="right-content">
		...
		<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/introduce.do?type=isg">${WEB_INTRO_NAVI}</a> - <a href="javascript:void(0);">${WEB_INTRO_XUESHU}</a></div>
	       <!--S 具体内容-->
