...
<body>
	...
	<div class="main">
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/achievement.do?type=kft">${WEB_RESULT_NAVI}</a> - <a href="javascript:void(0);">${type_name}</a></div>
			<!--S 具体内容-->
		    <div class="details-content-text">
		   		
		   		<c:forEach items="${achievement}" var="achievement">
		   			${achievement.item_content}
		   		</c:forEach>	
