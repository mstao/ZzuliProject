...
<body>
	...
	<%-- 		<li><a href="${pageContext.request.contextPath}/person.do?type=rxd&p=1" >${WEB_PERSON_XIE}</a></li> --%>
		...
		<div class="right-content">
			<div class="now-loaction-navi">您现在所在位置: <a href="${pageContext.request.contextPath}/index.do">首页</a> - <a href="${pageContext.request.contextPath}/person.do?p=1">${WEB_PERSON_NAVI}</a> - <a href="javascript:void(0);">${WEB_PERSON_STATUS}</a></div>
			<!--S 具体内容-->
		    <div class="details-content-text">
		    	<c:forEach items="${personintro}" var="personintro">
		    		${personintro.content}	
		    	</c:forEach>
		    </div>
		   <!--E 具体内容-->
