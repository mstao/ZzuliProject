...
<!--S main-->
 ...
 <a href="${pageContext.request.contextPath}/updatestudent.ado?type=${type}" class="add_list">
 <c:choose>
 ...
 <c:forEach items="${student}" var="student_info">
 <c:if test="${student_info.is_publish eq 0}"> <span class="intro-draft">草稿</span></c:if>
 </c:forEach>
