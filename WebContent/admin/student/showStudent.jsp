       				...
       				$.ajax({
						...
						success:function(data){
							...
							if(data>0){
								...
								window.location.href="${pageContext.request.contextPath}/showstudent.ado?type=${type}&p=1";
...
<!--S main-->
     <div class="new_div1"><span class="new_div1_span">${type_name}</span><a href="${pageContext.request.contextPath}/admin/student/writeStudent.jsp?type=${type}" class="add_list">新增</a></div>
     <div class="new_div2">
 ...
 <div class="new_div3">            
     <table>
         ...
         <tr>
             <td width="5%" align="center"><input type="checkbox" name="info_id" value="${stu_list.id}"/></td>
            
             <td width="35%"><a href="${pageContext.request.contextPath}/updatestudent.ado?id=${stu_list.id}&type=${stu_list.type_flag}" class="item_title" title="${stu_list.item_title}">${stu_list.item_title}</a>
	             <c:if test="${stu_list.is_publish eq 0}">
             ...
             <td width="20%" class="sub-time">${stu_list.add_time}</td>
         </tr>
         </c:forEach>
