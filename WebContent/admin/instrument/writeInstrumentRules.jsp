...
<div class="main">
	...
	<div class="edit-div"> 
		...
		<span class="edit-span">撰写${WEB_INSTRUMENT_RULES}(${WEB_INSTRUMENT_NAVI})</span>
		<span class="title-span">标题</span>
		<input type="text" name="eidt_title" class="edit-title" placeholder="标题">
		<span class="content-span">${WEB_INSTRUMENT_RULES}内容</span>
		<!--S 编辑器 -->              
        ...
        <div class="edit-submit">
        	<a href="javascript:void(0);" class="draft-btn draft-i-rule-btn" onClick="ChangeState();">保存草稿</a><a href="javascript:void(0);" class="publish-btn   publish-i-rule-btn" onClick="ChangeState();">发布内容</a>
        </div>
	</div>
	<!--E 编辑区域-->
	...
	<div class="check-zone">
		...
		<div class="options-checked-div" id="s">
		    ...
		    <select name="publish_style" id="publish-style">
		    	<option selected="true">${WEB_INSTRUMENT_RULES}</option>
		    </select>
		</div>
