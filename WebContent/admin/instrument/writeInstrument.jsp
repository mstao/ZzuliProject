...
<div class="main">
	<!--S 编辑区域-->
	<div class="edit-div"> 
		<span class="edit-span">撰写${WEB_INSTRUMENT_DETAILS}信息</span>
		...
		<span class="content-span">${WEB_INSTRUMENT_DETAILS}图片</span><br>
		<!--图片上传和展示信息  -->
		...
		if(img_url == ""){
    		...
    		if(name=="" || text_content=="" ||publish_dept==""){
    			...
    			$.ajax({
    				type:'post',
    				dataType:'text',
    				url:CTPPATH+'/addinstrument.ado',
    				data:{"name":name,"content":content,"ins_url":ins_url,"img_url":img_url,"author":publish_dept,"is_publish":is_publish},
