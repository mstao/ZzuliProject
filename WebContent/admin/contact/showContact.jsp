...
<title>${WEB_FOOTER_CONTACT}-后台管理</title>
...
<!--S main-->
 <div class="new_div1"><span class="new_div1_span">${WEB_FOOTER_CONTACT}</span>
 <a href="${pageContext.request.contextPath}/updatecontact.ado" class="add_list">
 <c:choose>
 ...
 <c:forEach items="${contact}" var="contact_info">
 <c:if test="${contact_info.is_publish eq 0}"> <span class="intro-draft">草稿</span></c:if>
 </c:forEach>
