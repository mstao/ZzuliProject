...
<div class="main">
	<!--S 编辑区域-->
	<div class="edit-div"> 
		<span class="edit-span">撰写${WEB_PERSON_GUGAN}信息</span>
		...
		if(img_url == ""){
    		...
    		if(name=="" || text_content=="" ||publish_dept==""){
    			...
    			$.ajax({
    				type:'post',
    				dataType:'text',
    				url:CTPPATH+'/addperson.ado',
    				data:{"person_name":name,"person_info":content,"person_post":post,"avatar_file":img_url,"author":publish_dept,"is_gugan":is_gugan,"is_publish":is_publish},
