...
<title>撰写-${WEB_RESEARCH_PROJECT_HORIZONTAL_COOPERATION}</title>
...
<div class="main">
	<!--S 编辑区域-->
	<div class="edit-div"> 
		<span class="edit-span">撰写${WEB_RESEARCH_PROJECT_HORIZONTAL_COOPERATION}信息</span>
		<span class="title-span">项目名称</span>
		<input type="text"  class="edit-title edit-project-name" placeholder="项目名称">
		<span class="title-span">合作单位</span>
		<input type="text"  class="edit-title edit-project-cooperator" placeholder="合作单位">
        <span class="title-span">负责人</span>
		<input type="text"  class="edit-title edit-project-person" placeholder="负责人">
		<span class="title-span">合同经费（万元）</span>
		<input type="text"  class="edit-title edit-project-outlay" placeholder="合同经费（万元）">
		
		<span class="title-span">年份</span>
		<input type="text"  class="edit-title edit-project-time" placeholder="年份">
        <div class="edit-submit">
        	<a href="javascript:void(0);" class="draft-btn draft-cooperator-btn" onClick="ChangeState();">保存草稿</a><a href="javascript:void(0);" class="publish-btn publish-cooperator-btn" onClick="ChangeState();">发布内容</a>
        </div>
	</div>
	<!--E 编辑区域-->
	...
	$(".publish-cooperator-btn").bind("click",function(){
		...
		if(name=="" || cooperator == "" || person=="" || outlay=="" || time==""){
			...
			$.ajax({
				type:'post',
				dataType:'text',
				url:CTPPATH+'/addcooperation.ado',
				data:{"name":name,"person":person,"cooperator":cooperator,"outlay":outlay,"time":time,"is_publish":is_publish},
