...
<div class="main">
	...
	<div class="edit-div"> 
		...
		<input type="text"  class="edit-title edit-project-publication_division" placeholder="刊物名称">
        <span class="title-span">年、期、卷、页码</span>
		<input type="text"  class="edit-title edit-project-page_number" placeholder="年、期、卷、页码">
