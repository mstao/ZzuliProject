...
<title>${WEB_RESULT_LUNWEN}列表-后台管理</title>
       				...
       				$.ajax({
						...
						success:function(data){
							...
							if(data>0){
								...
								window.location.href="${pageContext.request.contextPath}/showthesis.ado?p=1";
...
<!--E header-->
<!--S main-->
     <div class="new_div1"><span class="new_div1_span">${WEB_RESULT_LUNWEN}</span><a href="${pageContext.request.contextPath}/admin/result/writeThesis.jsp" class="add_list">新增</a></div>
     <div class="new_div2">
 ...
 <div class="new_div3">            
     <table>
         ...
         <tr>
             ...
             <td  align="center"><input type="checkbox" name="info_id" value="${thesis.id}"/></td>
            
             <td >${thesis.style}</td>
             <td >${thesis.author}</td>
             <td><a href="${pageContext.request.contextPath}/updatethesis.ado?id=${thesis.id}" class="item_title" title="${thesis.name}">${thesis.name}</a>
	             <c:if test="${thesis.is_publish eq 0}">
