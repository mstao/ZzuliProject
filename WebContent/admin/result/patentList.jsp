...
<title>${WEB_RESULT_ZHUANLI}列表-后台管理</title>
       				...
       				$.ajax({
						...
						success:function(data){
							...
							if(data>0){
								...
								window.location.href="${pageContext.request.contextPath}/showpatent.ado?p=1";
...
<!--E header-->
<!--S main-->
     <div class="new_div1"><span class="new_div1_span">${WEB_RESULT_ZHUANLI}</span><a href="${pageContext.request.contextPath}/admin/result/writePatent.jsp" class="add_list">新增</a></div>
     <div class="new_div2">
 ...
 <div class="new_div3">            
     <table>
         <tr>
          ...
          <c:forEach items="${patent}" var="patent" varStatus="hx">
         <tr>
             <td  align="center"><input type="checkbox" name="info_id" value="${patent.id}"/></td>
             <td><a href="${pageContext.request.contextPath}/updatepatent.ado?id=${patent.id}" class="item_title" title="${patent.name}">${patent.name}</a>
	             <c:if test="${patent.is_publish eq 0}">
