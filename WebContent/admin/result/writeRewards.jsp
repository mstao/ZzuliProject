...
<title>撰写-${WEB_RESULT_REWRADS}</title>
...
<div class="main">
	<!--S 编辑区域-->
	<div class="edit-div"> 
		<span class="edit-span">撰写${WEB_RESULT_REWRADS}信息</span>
		...
		<input type="text"  class="edit-title edit-project-awards" placeholder="奖励情况">
        <span class="title-span">获奖者</span>
		<input type="text"  class="edit-title edit-project-person" placeholder="获奖者">		
		<span class="title-span">时间</span>
		<input type="text"  class="edit-title edit-project-time" placeholder="时间">
        <div class="edit-submit">
        	<a href="javascript:void(0);" class="draft-btn draft-rewards-btn" onClick="ChangeState();">保存草稿</a><a href="javascript:void(0);" class="publish-btn publish-rewards-btn" onClick="ChangeState();">发布内容</a>
        </div>
	</div>
	<!--E 编辑区域-->
	...
	$(".publish-rewards-btn").bind("click",function(){
		...
		if(name=="" || awards == "" || person==""  || time==""){
			...
			$.ajax({
				type:'post',
				dataType:'text',
				url:CTPPATH+'/addrewards.ado',
				data:{"name":name,"awards":awards,"person":person,"time":time,"is_publish":is_publish},
