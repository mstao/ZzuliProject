...
<title>修改-${WEB_RESULT_LUNWEN}</title>
...
<div class="main">
	<!--S 编辑区域-->
	<div class="edit-div"> 
		<span class="edit-span">修改${WEB_RESULT_LUNWEN}信息
		<c:if test="${thesis.is_publish eq 0}"><b>草稿</b></c:if>
		</span>
		<span class="title-span">成果类型</span>
		<input type="text"  class="edit-title edit-project-style" placeholder="成果类型" value="${thesis.style}">
	...
	$(".publish-thesis-btn").bind("click",function(){
		...
		if(name=="" || style == "" || author==""  || publication_division=="" || page_number==""){
			...
			$.ajax({
				type:'post',
				dataType:'text',
				url:CTPPATH+'/dealupdatethesis.ado',
				data:{"id":id,"style":style,"author":author,"name":name,"publication_division":publication_division,"page_number":page_number,"is_publish":is_publish},
