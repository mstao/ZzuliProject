...
<title>${WEB_INTRO_GUANLI}列表-后台管理</title>
       				...
       				$.ajax({
						...
						success:function(data){
							...
							if(data>0){
								...
								window.location.href="${pageContext.request.contextPath}/showcommittee.ado?type=manage&p=1";
...
<!--E header-->
<!--S main-->
<div class="new_div1"><span class="new_div1_span">${WEB_INTRO_GUANLI}</span></div>
<div class="new_div1 committee_intro_span"><span class="new_div1_span">${WEB_INTRO_GUANLI}介绍信息</span><a href="${pageContext.request.contextPath}/updatecommitteeintro.ado?type=glw&style=manage" class="add_list">
     <c:choose>
...
<!--E 介绍信息  -->     
<div class="new_div1"><span class="new_div1_span">${WEB_INTRO_GUANLI}人员列表</span><a href="${pageContext.request.contextPath}/admin/introduce/AddOtherCommittee.html?type=manage" class="add_list">新增</a></div>     
<div class="new_div2">
 ...
 <div class="new_div3">            
     <table>
         ...
         <tr>
             ...
             <td width="10%"><a href="${pageContext.request.contextPath}/updatecommittee.ado?type=manage&id=${committee_list.id}" class="item_title" title="${committee_list.name}">${committee_list.name}</a>
