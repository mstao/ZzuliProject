...
<title>${WEB_INTRO_SHIYAN}列表-后台管理</title>
       				...
       				$.ajax({
						...
						success:function(data){
							...
							if(data>0){
								...
								window.location.href="${pageContext.request.contextPath}/showcommittee.ado?type=director&p=1";
...
<!--E header-->
<!--S main-->
<div class="new_div1"><span class="new_div1_span">${WEB_INTRO_SHIYAN}</span></div>
<div class="new_div1 committee_intro_span"><span class="new_div1_span">${WEB_INTRO_SHIYAN}介绍信息</span><a href="${pageContext.request.contextPath}/updatecommitteeintro.ado?type=szw&style=director" class="add_list">
     <c:choose>
...
<c:when test="${not empty committeeintro}">
	 ...
	 <div class="new_div2  intro-show-div">
		 <c:forEach items="${committeeintro}" var="employ_info">
		 ${employ_info.content}
		 </c:forEach>
...
<div class="new_div1"><span class="new_div1_span">${WEB_INTRO_SHIYAN}人员列表</span><a href="${pageContext.request.contextPath}/admin/introduce/AddDirectorCommittee.html" class="add_list">新增</a></div>     
<div class="new_div2">
 ...
 <div class="new_div3">            
     <table>
         ...
         <tr>
             ...
             <td width="10%"><a href="${pageContext.request.contextPath}/updatecommittee.ado?type=director&id=${committee_list.id}" class="item_title" title="${committee_list.name}">${committee_list.name}</a>
