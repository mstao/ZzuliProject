...
<title>${WEB_EMPLOY_NAVI}-后台管理</title>
...
<!--S main-->
 <div class="new_div1"><span class="new_div1_span">${WEB_EMPLOY_NAVI}</span>
 <a href="${pageContext.request.contextPath}/updateemploy.ado" class="add_list">
 <c:choose>
 ...
 <c:if test="${employ_info.is_publish eq 0}"> <span class="intro-draft">草稿</span></c:if>
 </c:forEach>
