       				...
       				$.ajax({
						...
						success:function(data){
							...
							if(data>0){
								...
								window.location.href="${pageContext.request.contextPath}/ruleslist.ado?p=1";
...
<!--E header-->
<!--S main-->
     <div class="new_div1"><span class="new_div1_span">${WEB_INTRO_RULES}</span><a href="${pageContext.request.contextPath}/admin/rules/writeRules.html" class="add_list">新增</a></div>
     <div class="new_div2">
 ...
 <div class="new_div3">            
     <table>
         ...
         <tr>
             ...
             <td width="35%"><a href="${pageContext.request.contextPath}/updaterule.ado?id=${rules_list.id}" class="item_title" title="${rules_list.rule_title}">${rules_list.rule_title}</a>
