...
<script type="text/javascript">
	...
	$(function() {
		...
		}else if("${type_flag}"=="kcz"){
			$(".edit-span").text("撰写${WEB_RESULT_ZHUANHUA}");
			$(".content-span").text("${WEB_RESULT_ZHUANHUA}内容");
		}
...
<div class="main">
	...
	<div class="edit-div"> 
		...
		<span class="edit-span">撰写${WEB_RESULT_ZHUANHUA}</span>
		<span class="title-span">标题</span>
		<input type="text" name="eidt_title" class="edit-title" placeholder="标题">
		<span class="content-span">${WEB_RESULT_ZHUANHUA}内容</span>
		<!--S 编辑器 -->              
        ...
        <div class="edit-submit">
        	...
        	<a href="javascript:void(0);" class="draft-btn draft-achievement-btn"  onClick="ChangeState();">保存草稿</a><a href="javascript:void(0);" class="publish-btn   publish-achievement-btn" onClick="ChangeState();">发布内容</a>
	...
	<div class="check-zone">
		...
		<div class="options-checked-div" id="s">
		    ...
		    <select name="publish_style" id="publish-style">
		    	...
		    	<option value="kcz" <c:if test="${type_flag eq 'kcz'}">selected="true"</c:if> >${WEB_RESULT_ZHUANHUA}</option>
