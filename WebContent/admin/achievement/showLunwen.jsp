...
<!--E header-->
<!--S main-->
     <div class="new_div1"><span class="new_div1_span">${type_name}</span><a href="${pageContext.request.contextPath}/admin/achievement/writeLunwen.html?type=${type}" class="add_list">新增</a></div>
     <div class="new_div2">
 ...
 <div class="new_div3">            
     <table>
         ...
         <tr>
             ...
             <td width="35%"><a href="${pageContext.request.contextPath}/updateachievement.ado?type=${type}&id=${achievement_list.id}" class="item_title">${achievement_list.item_content}</a>
